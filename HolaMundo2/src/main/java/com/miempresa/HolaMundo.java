...
public class HolaMundo {
	...
	public String Saludar() {
		String saludo = "<h1> Hola mundo desde <b> Spring Boot</b> </h1>";
				saludo += "<a href='/'>Volver</a> <br>";
				return saludo;
	}

	@RequestMapping ("/misdatos")
	public String MisDatos() {
		String nombres = "Jaime Rodriguez";
		int edad = 23;
		String curso = "Desarrollo de Aplcaciones Web";
		String foto = "perrito.jpg";
		
		String datos = "<table border=1>";
		datos += "<tr><td colspan=2><img src=" + foto +"> <br> <center><h1>Porque JAVA?</h1></center> </td></tr> ";
